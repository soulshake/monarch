...
INSERT INTO `setup` VALUES
	...
	('nagios_check_command','nagios_cgi','/usr/local/nagios/libexec/check_nagios /usr/local/nagios/var/status.log 5 \'/usr/local/nagios/bin/.nagios.bin\''),
